-- TRIGGER : 테이블이나 뷰가 DML문(INSERT, UPDATE, DELETE)에 의해 변경될 경우,
...
VALUES(999, '홍하하', '990611-1454545', 'hong_hh@kh.or.kr', '01012343212', 'D5', 'J3', 'S5',
...
INSERT INTO PRO_DETAIL VALUES(SEQ_DCODE.NEXTVAL, 1, SYSDATE, 7, '입고'); -- 1번 상품 7개 입고
UPDATE PRODUCT SET STOCK = STOCK+7 WHERE PCODE = 1;
INSERT INTO PRO_DETAIL VALUES(SEQ_DCODE.NEXTVAL, 2, SYSDATE, 3, '출고'); -- 2번 상품 3개 출고
