...
VALUES(902, 'S3', 'J7', '000223-3011231', '도대담');
...
AS SELECT EMP_ID, EMP_NAME, MANAGER_ID
   FROM EMPLOYEE
   WHERE 1 = 0;
--DDL 수행하면 알아서 COMMIT함!!!!!!!
-- EMP_DEPT_D1테이블에 EMPLYEE테이블에 있는 부서코드가 D1인 직원을 조회하여 
...
-- EMPLOYEE테이블의 입사일을 기준으로 2000년 1월 1일 이전에 입사한 사원의
...
--UPDATE : 테이블에 기록된 값을 수정하는 구문 = 행 개수 변화 X
--UPDATE 테이블명 SET 컬럼명 = 바꿀값1, 컬럼명2 = 바꿀값2, ... WHERE 조건식;
COMMIT;
...
--방명수 사원의 급여와 보너스를 유재식 사원과 동일하게 변경(EMLOYEE_COPY)
